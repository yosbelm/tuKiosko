...
export default function UsuarioCuenta () {
  ...
  return (
    <div className={`transition-colors duration-300 ${darkMode ? 'bg-slate-900 text-white' : 'bg-gray-50 text-gray-800'} min-h-screen px-6 pt-2`}>
      
      {/* Header con Switch de Modo Oscuro */}
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-2">
          {/* <div className="w-1 h-6 bg-[#1c2d47] dark:bg-[#1de9b6] rounded"></div> */}
          <h2 className="text-xl font-bold tracking-tight">Mi Perfil de Usuario</h2>
        </div>
