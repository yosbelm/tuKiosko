"""
Django settings for tuKiosko project.
...
WSGI_APPLICATION = 'tuKiosko.wsgi.application'
...
# Opcional pero recomendado para que Django encuentre tus archivos locales:
STATICFILES_DIRS = [
